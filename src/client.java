...
public final class client extends Applet_Sub1 {
			...
			for(int j1 = 0; j1 < 4; j1++)
				if(((Class30_Sub2_Sub4_Sub1) (obj)).anIntArray1516[j1] > anInt1161) {
					...
					if(anInt963 > -1) {
						...
						int j2 = ((Class30_Sub2_Sub4_Sub1) (obj)).anIntArray1515[j1];
						if(j2 < aClass30_Sub2_Sub1_Sub1Array987.length){
							aClass30_Sub2_Sub1_Sub1Array987[j2].method348(anInt963 - 12, 16083, anInt964 - 12);
	...
	public final void method13(int i, byte byte0, String s)
	{
		...
		char c1 = '\310';
		byte byte1 = 20;
		aClass30_Sub2_Sub1_Sub4_1272.method381(128, ""+SERVERNAME+" is loading - please wait...", 23693, c1 / 2 - 26 - byte1, c / 2);
		int j = c1 / 2 - 18 - byte1;
		// Colours
					...
					if(anInt1282 == 1)
					{
						...
						} else
						{
							for(int j3 = 4; j3 >= 0; j3--){
								...
								{
									//TODO - this added that fourth ".." option for items with high IDs
...
//									anInt1133++;
						...
						if(anInt1225 == 2)
						{
							...
							if(anInt1276 == -1)
							{
								...
								if((j == 13 || j == 10) && aString887.length() > 0)
								{
									...
									else if(aString887.startsWith("/")) {
										aClass30_Sub2_Sub2_1192.method397((byte)6, 103);
										aClass30_Sub2_Sub2_1192.method398(aString887.length()+2);
		...
		if(j == 613)
			if(anInt863 >= 1)
			{
				if(aBoolean1158)
				{
					...
					class9.aString248 = "Mute player for 48 hours: <ON>";
				} else
				{
					class9.anInt232 = 0xffffff;
					class9.aString248 = "Mute player for 48 hours: <OFF>";
				}
			} else
			{
				class9.aString248 = "";
	...
	public final void method84(String s, String s1, boolean flag) {
		...
		try {
			if(!flag) {
				aString1266 = "@whi@"+SERVERNAME+" - Establishing Connection";
			...
			if(k == 6) {
				aString1266 = "@gre@"+SERVERNAME+" has been updated!";
		...
		aString1267 = "@whi@Error Connecting to "+SERVERNAME+"...";
	}
	...
	private final void method91(Class30_Sub2_Sub2 class30_sub2_sub2, int i, byte byte0)
	{
		...
		{
			int j = class30_sub2_sub2.method419(11, 0); //TODO - used to be 11,0, has to with player updating
			if(j == 2047)
				break;
	...
	public final void method94(int i)
	{
		...
		if(aBoolean926)
		{
			...
			int k = 35;
			g.drawString("Sorry, an error has occured whilst loading "+SERVERNAME+".", 30, k);
			k += 50;
		...
		if(aBoolean1252)
		{
			...
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of "+SERVERNAME+" already appears to be loaded", 30, l);
			l += 50;
			g.setColor(Color.white);
	...
	public final void method102(boolean flag)
	{
		...
		if(aBoolean1233)
		{
			...
			if(anInt1287 == 1)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xffff00, 55, anInt939, ""+caption1+"@yel@Friends", 41, true);
			if(anInt1287 == 2)
			...
			if(anInt1248 == 1)
				aClass30_Sub2_Sub1_Sub4_1271.method382(0xffff00, 324, anInt939, ""+caption3+"@yel@Friends", 41, true);
			if(anInt1248 == 2)
				...
				if((k == 3 || k == 7) && (k == 7 || anInt845 == 0 || anInt845 == 1 && method109(false, s)))
				{
					...
					if(super.anInt20 > 4 && super.anInt21 - 4 > l - 10 && super.anInt21 - 4 <= l + 3)
					{
						...
						if(super.anInt20 < 4 + i1)
						{
							if(anInt863 >= 1)
							{
								aStringArray1199[anInt1133] = ""+SERVERNAME+" @whi@" + s;
	...
	public final void method135(boolean flag, boolean flag1) {
		...
		if(anInt833 == 0) {
			...
			i = c1 / 2 - 20;
			aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "@whi@Welcome to "+SERVERNAME, i, true);
			i += 30;
			int l = c / 2 - 80;
			int k1 = c1 / 2 + 20;
			aClass30_Sub2_Sub1_Sub2_967.method361(l - 73, 16083, k1 - 20);
			aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "@whi@  About", k1 + 5, true);
			l = c / 2 + 80;
			aClass30_Sub2_Sub1_Sub2_967.method361(l - 73, 16083, k1 - 20);
			aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, l, anInt939, "@whi@Enter", k1 + 5, true);
		}
		if(anInt833 == 2) {
			int j = c1 / 2 - 40;
			...
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffFF, "@whi@Login Name: @gre@" + aString1173 + ((anInt1216 == 0) & (anInt1161 % 40 < 20) ? "@xxx@|" : ""), j);
			j += 15;
			aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xffffff, "@whi@Password: @gre@" + Class50.method588(aString1174, 0) + ((anInt1216 == 1) & (anInt1105 % 40 < 20) ? "|" : ""), j);
			j += 15;
			if(!flag) {
				int i1 = c / 2 - 80;
				int l1 = c1 / 2 + 50;
		...
		if(anInt833 == 3) {
			...
			int k = c1 / 2 - 35;
			aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "SarimScape is a working project", k, true);
			k += 15;
			aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "of AAA Mods.", k, true);
			k += 15;
			...
			aClass30_Sub2_Sub1_Sub4_1272.method382(0x33CCFF, j1, anInt939, "@whi@Back", i2 + 5, true);
		}
		aClass15_1109.method238(171, 23680, super.aGraphics12, 202);
		if(aBoolean1255) {
			aBoolean1255 = false;
	...
	public final boolean method145(boolean flag)
	{
		...
		try
		{
			...
			if(anInt1008 == 73 || anInt1008 == 241)
			{
				...
				aLong824 = System.currentTimeMillis();
				aClass15_1165.method237(0);
				Class30_Sub2_Sub1.method337(1, 130, 23, 0xffffff, 2, true);
				Class30_Sub2_Sub1.method336(21, 3, 2, 0, 128, 0);
				aClass30_Sub2_Sub1_Sub4_1271.method381(0, "Loading - please wait.", 23693, 19, 67);
				aClass30_Sub2_Sub1_Sub4_1271.method381(0xffffff, "Loading - please wait.", 23693, 18, 66);
				aClass15_1165.method238(4, 23680, super.aGraphics12, 4);
				if(anInt1008 == 73)
				{
					int k16 = 0;
			...
			if(anInt1008 == 50)
			{
				...
				for(int k24 = 0; k24 < anInt899; k24++)
				{
					...
					if(anIntArray826[k24] != i18)
					{
						...
						if(i18 == 0){ //TODO fix this?
							method77(s7 + " has logged in/out", 5, "", aBoolean991);
						}
					}
					s7 = null;
					break;
	...
	public static boolean aBoolean1153;
