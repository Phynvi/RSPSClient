...
implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener
{
	...
	public void takeScreenshot() {
		try {
			...
			String fileName = (new StringBuilder()).append(sign.signlink.findcachedir() + "Screenshots/" + fileExtension + " ").append(timeStamp).append(".png").toString();
...
//		}
//		else{
//	    BufferedImage img=ImageIO.read(new File(sign.signlink.findcachedir()+"/WorldMapVersion8.png"));
//	    ImageIcon icon=new ImageIcon(img);
//	    mapFrame = new JFrame();
//	    mapFrame.setLayout(new FlowLayout());
